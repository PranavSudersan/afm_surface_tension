...
simu_folderpath2 = 'E:/Work/Surface Evolver/afm_pyramid/data/20220113_rfesp_np/'

###drop analysis of AFM data
drop_df, output_path = wetting.get_drop_prop(file_path, fd_file_paths,
                                             level_order=2, fit_range=[60,62])#5000 [70,75]

#get simulation data for tip geometry
simu_df1 = wetting.combine_simul_data(simu_folderpath1)
...
contact_angle = 50 #INPUT (None for auto calculation from FD)
